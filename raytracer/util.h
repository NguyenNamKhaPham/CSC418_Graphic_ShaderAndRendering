...
struct Material {
	Material(Colour ambient, Colour diffuse, Colour specular, double exp, double index, bool transmissive) :
		ambient(ambient), diffuse(diffuse), specular(specular),
		specular_exp(exp), refracIndex(index), transmissive(transmissive) {}
